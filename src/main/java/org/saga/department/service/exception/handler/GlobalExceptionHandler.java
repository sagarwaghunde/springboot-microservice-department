package org.saga.department.service.exception.handler;
...
import org.saga.department.service.exception.ErrorDetails;
...
//	@ExceptionHandler(EmailAlreadyExistsException.class)
	@ExceptionHandler
	public ResponseEntity<ErrorDetails> handleResourceNotFoundException(DeptCodeAlreadyExistsException exception,
																		WebRequest webRequest) {
		ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), exception.getMessage(), webRequest.getDescription(false), "DEPARTMENT_CODE_ALREADY_EXISTS");
